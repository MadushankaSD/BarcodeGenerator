...
public class JPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, JpaVendorAdapter jpaVendorAdapter){
        ...
        lcemfb.setPackagesToScan("io.generator.barcode.project.entity");
        return lcemfb;
    }
    ...
    public JpaVendorAdapter jpaVendorAdapter(){
        ...
        jpaVendorAdapter.setShowSql(env.getRequiredProperty("hibernate.show_sql",Boolean.class));
        jpaVendorAdapter.setGenerateDdl(env.getRequiredProperty("hibernate.hbm2ddl.auto").equals("update")?true:false);
